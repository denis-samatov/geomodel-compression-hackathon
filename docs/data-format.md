...
Для старта достаточно скачать модель из Google Drive, распаковать её локально и работать с каталогом напрямую. Отдельный манифест, checksum-проверка и специальный скрипт скачивания со стороны участника не требуются.
